...
namespace IconConverter
{
    ...
    {
        private static bool Convert(System.IO.Stream input_stream, System.IO.Stream output_stream, int size, bool keep_aspect_ratio = false)
        {
        ...
        {
            System.IO.Stream input_stream = new System.IO.FileStream(input_image, System.IO.FileMode.Open);
